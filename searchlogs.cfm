...
<table style="width: 60%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td style="width: 2%">&nbsp;</td>
		<td colspan="4"><strong><span class="style1"><center>Event Log Search</center></span></strong><hr>
		<br />
		</td>
	</tr>
	<tr>
		...
		<cfform method="post" action="searchviewer.cfm" id="searchform">
		<strong>Choose Beginning Date:</strong> <input type="date" name="beginningdate" id="beginningdate" required>
		<strong>Choose Ending Date:</strong> <input type="date" name="endingdate" id="endingdate" required><br><br>
		<strong>Keyword(s) (optional):</strong><input type="text" name="keyword" id="keyword"><br><br>
		<input type="submit" value="Search Event Logs" />
