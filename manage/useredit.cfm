...
<cfset varUserID=URL.UserID />
<cfquery name="qryUser" datasource="jdcdb">
	SELECT *
	FROM OFFICERS
...
<table style="width: 60%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<cfif URL.Edited EQ "0">
		<cfoutput><span class="fa-inverse">User: #qryUser.FirstName# #qryUser.LastName# has been created.</span></cfoutput></td>		
		<cfelseif URL.Edited EQ "1">
		<cfoutput><span class="fa-inverse">User: #qryUser.FirstName# #qryUser.LastName# has been edited.</span></cfoutput></td>
		<cfelse>
		<cfoutput><span class="fa-inverse">Editing User: #qryUser.FirstName# #qryUser.LastName#</span></cfoutput></td>
		</cfif>
	</tr>
	<tr>
		<td style="width: 5%" class="style5">&nbsp;</td>
		...
		<center>
		<cfform method="post" action="usereditinsert.cfm?UserID=#varUserID#" id="userform">
		<table style="width: 80%" class="style7">
			<tr class="style6">
				<td style="width: 25%">First Name:</td>
				<td><input type="text" name="FirstName" id="FirstName" size="40" <cfoutput>value="#qryUser.FirstName#"</cfoutput>></td>
			</tr>
			<tr class="style6">
				<td style="width: 25%">Last Name:</td>
				<td><input type="text" name="LastName" id="LastName" size="40" <cfoutput>value="#qryUser.LastName#"</cfoutput>></td>
			</tr>
			<tr class="style6">
				<td style="width: 25%">Job Title:</td>
				<td><input type="text" name="JobTitle" id="JobTitle" size="40" <cfoutput>value="#qryUser.JobTitle#"</cfoutput>></td>
			</tr>
			<tr class="style6">
				<td style="width: 25%">Phone:</td>
				<td><input type="text" name="Phone" id="Phone" size="40" <cfoutput>value="#qryUser.Phone#"</cfoutput>></td>
			</tr>
			<tr class="style6">
				<td style="width: 25%">Email:</td>
				<td><input type="text" name="Email" id="Email" size="40" <cfoutput>value="#qryUser.Email#"</cfoutput>></td>
			</tr>
			<tr class="style6">
				<td style="width: 25%">Status:</td>
				<td>
				<cfif qryUser.Archived EQ "True">
				<select id="Archived" name="Archived" >
   				<option value="False">Active</option>				
    			<option value="True" selected="selected">Inactive</option>
			 	</select>
				<cfelse>
				<select id="Archived" name="Archived" >
