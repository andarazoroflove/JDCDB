...
<table style="width: 60%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		THIS BUTTON:<br />
		<br />
		<button class="btn" onclick="location.href='truncateincident.cfm'" type="button" align="center"><i class="fa fa-exclamation"></i> CLEAR ALL INCIDENTS</button>
		<br />
		<br />
		<strong>WILL IMMEDATELY ELIMINATE ALL INCIDENTS IN THE DATABASE<br />
		<br />
		THIS IS IRREVERSABLE, SO MAKE A BACKUP BEFORE USING IT!</strong><br />
		</td>
	</center>
	</tr>
	<tr>
