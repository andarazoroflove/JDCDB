...
<cfquery name="qrypreviousevents" datasource="jdcdb">
	SELECT *
	FROM EventLog
	WHERE DATE = '#DateFormat(Now(), "mmmm dd, yyyy")#'
	ORDER BY TIME ASC
</cfquery>
...
<table style="width: 60%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<strong>Event Log for <cfoutput>#DateFormat(Now(), "mmmm dd, yyyy")#</cfoutput></strong></center></span></strong><hr>
		<strong></strong>
		</td>
	</tr>
	<tr>
		<td colspan="4">
			...
			<tr class="style8">
				...
				<td width="70%" class="style10"><strong>EVENT</strong></td>
		...
		<cfloop query="qrypreviousevents">
			...
			<tr class="style8">
				<td width="10%" class="style12">#qrypreviousevents.time# <a class="blacknounderline" title="Last Edited at #qrypreviousevents.edittime#">#varedited#</a></td>
				<td width="70%" class="style12"><a href="eventedit.cfm?Event=#qrypreviousevents.eventid#" class="blacknounderline">#qrypreviousevents.event#</a></td>
	...
	<tr>
		...
		<strong>TIME:</strong> <cfinput type="Text" name="Time" size="5">
		...
		<textarea form="eventform" name="eventtext" id="eventtext" cols="85" rows="5" wrap="soft"></textarea><br>
