...
<cfquery name="qryNight" datasource="jdcdb">
	...
	WHERE NightDate = '#form.BeginningDate#'
</cfquery>
...
<table style="width: 60%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td style="width: 2%">&nbsp;</td>
		<td colspan="4"><strong><span class="style1"><center>Shift Summary 
		Options</center></span></strong><hr>
		<br />
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td style="width: 5%" class="style5">&nbsp;</td>
		<td style="width: 2%">&nbsp;</td>
		<td colspan="4" class="style2" rowspan="2">&nbsp;</td>
	</tr>
	<tr>
		<td style="width: 5%" class="style5">&nbsp;</td>
		<td style="width: 2%">&nbsp;</td>
...
<cflocation url="shiftsummarynightview.cfm?NightID=#qryNight.NightID#" />
