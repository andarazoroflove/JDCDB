...
<table style="width: 60%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td style="width: 2%">&nbsp;</td>
		<td colspan="4"><strong><span class="style1"><center>Incident Report Searching</center></span></strong>
		<forhr>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<cfform method="post" action="searchincidentview.cfm" id="searchform">
		<strong>Choose Beginning Date:</strong> <input type="date" name="beginningdate" id="beginningdate" value="2024-01-01">
		<strong>Choose Ending Date:</strong> <input type="date" name="endingdate" id="endingdate" value="2042-11-13"><br><br>
		<strong>Incident Type Keyword (optional):</strong><input type="text" name="keyword" id="keyword"><br><br>
		<input type="submit" value="Search Incident Reports" />
		</cfform>
		</td>
	</tr>
	<tr>
